...
$usernm = ( isset($HTTP_GET_VARS['ARG3']) ) ? ($HTTP_GET_VARS['ARG3']) : ( ( isset($HTTP_POST_VARS['ARG3']) ) ? ($HTTP_POST_VARS['ARG3']) : 0) ;
//
...
?>
<body>
<form enctype="multipart/form-data" action="usmle_upload.php" method=post>
	...
	<input type ="submit" value="Send File">
  	...
  	<input type="hidden" name="cat" value="<?php echo $ca; ?>" />
	<input type="hidden" name="usr_nm" value="<?php echo $usernm; ?>" />
</form>
