...
<td bgcolor="#006600" width="6" align="right"><img src="{S_ROOTDIR}templates/{T_STYLESHEET}/images/top_left.jpg" width="6" height="24" border="0"></td>
    <td bgcolor="#006600" nowrap width="80"  class="whitemed"><b>Comments</b></td>
...
<!-- BEGIN comments -->
			...
			<tr>
  				<td>
					<iframe frameborder="1" name ="myIFrame" scrolling="auto" width="100%" height="240" align="middle" src="{comments.SRC}"></iframe>
  				</td>
			</tr>
			<tr>
  				<td align="left" valign="bottom" class="gen" height="105">
					<form name="ques_comments" method="post" action="{comments.FORM_ACTION}">
						<input type="hidden" name="action">
						&nbsp;Please type your comments<br>&nbsp;&nbsp;
						<textarea name="comments" value="" rows="4" cols="40"></textarea>
						&nbsp;&nbsp;<a href="javascript:void(0);" class="action" onClick="submit_form(document.ques_comments, 'add')"> Post Comment </a> &nbsp;&nbsp;
					</form>
  				</td>
			</tr>
			</table>
